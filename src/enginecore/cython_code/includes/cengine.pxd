...
from includes.nanogui cimport FormHelper, FormWidget, Button, TextBox, FloatBox, CustomTextBox
...
cdef extern from "../c/engine.h":
    ...
    void setTextBoxKeyCallback(CustomTextBox* textBox, void* self, bool(*callback)(void* self, const string& _str)) except +
